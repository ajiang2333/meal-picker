...
INSERT INTO "new_Order" ("id", "userId", "storeId", "orderTime", "mealTime", "category", "total", "deliveryFee", "rating", "disliked", "note", "rawText", "createdAt", "updatedAt")
SELECT "id", "userId", "storeId", "orderTime", "mealTime", "category", "total", "deliveryFee", CAST("rating" AS REAL), "disliked", "note", "rawText", "createdAt", "updatedAt" FROM "Order";
